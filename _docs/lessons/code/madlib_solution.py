...
float_1 = float(input("Enter a decimal number between 0 and 4.0: "))
...
print("It's about " + name_1 + " and the " + str(number) + " Python programmers. ")
print(name_1 + " is a computing wizard with a GPA of " + str(float_1) + " whose talent threatens " + name_2 + ".")
